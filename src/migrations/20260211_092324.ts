...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_ads_position" AS ENUM('header-banner', 'sidebar', 'in-article', 'mobile-banner', 'footer-banner');
  ...
  CREATE TABLE IF NOT EXISTS "ads" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"position" "enum_ads_position" NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Ahmetli Sosyal',
  	"site_description" varchar DEFAULT 'Ahmetli''''nin en güncel haber portalı',
  	"logo_id" integer,
  	...
  	"footer_copyright" varchar DEFAULT '© 2024 Ahmetli Sosyal. Tüm hakları saklıdır.',
  ...
  CREATE INDEX IF NOT EXISTS "news_tags_order_idx" ON "news_tags" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "news_tags_parent_id_idx" ON "news_tags" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "ads_image_idx" ON "ads" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "ads_updated_at_idx" ON "ads" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "ads_created_at_idx" ON "ads" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "polls_options_order_idx" ON "polls_options" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "polls_options_parent_id_idx" ON "polls_options" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "polls_updated_at_idx" ON "polls" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "polls_created_at_idx" ON "polls" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_ads_id_idx" ON "payload_locked_documents_rels" USING btree ("ads_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_polls_id_idx" ON "payload_locked_documents_rels" USING btree ("polls_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_ads_position";`)
}
